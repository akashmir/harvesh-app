...
def init_database():
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS rotation_plans (
            ...
            current_crop VARCHAR NOT NULL,
            soil_conditions VARCHAR NOT NULL,
            rotation_sequence VARCHAR NOT NULL,
            rotation_duration INTEGER NOT NULL,
            expected_benefits VARCHAR,
            implementation_notes VARCHAR,
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS rotation_history (
            ...
            crop_planted VARCHAR NOT NULL,
            planting_date DATE NOT NULL,
            harvest_date DATE,
            soil_health_before VARCHAR,
            soil_health_after VARCHAR,
