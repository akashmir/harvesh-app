...
def init_database():
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS soil_properties (
            ...
            sand_content FLOAT NOT NULL,
            silt_content FLOAT NOT NULL,
            clay_content FLOAT NOT NULL,
            bulk_density FLOAT NOT NULL,
            cation_exchange_capacity FLOAT NOT NULL,
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS soil_health_indicators (
            ...
            fertility_index FLOAT NOT NULL,
            erosion_risk FLOAT NOT NULL,
            compaction_level FLOAT NOT NULL,
            water_holding_capacity FLOAT NOT NULL,
            nutrient_availability FLOAT NOT NULL,
            biological_activity FLOAT NOT NULL,
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS iot_sensor_data (
            ...
            nutrient_n FLOAT NOT NULL,
            nutrient_p FLOAT NOT NULL,
            nutrient_k FLOAT NOT NULL,
            electrical_conductivity FLOAT NOT NULL,
            timestamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP
        )
    ''')
