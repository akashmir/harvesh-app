"""
Simple Market Price API for Agmarknet Integration
Lightweight Flask API for market prices without heavy dependencies
"""
...
# Database setup
DB_NAME = 'simple_market_price.db'
...
def health_check():
    ...
    return jsonify({
        "success": True,
        "message": "Simple Market Price API is running",
...
if __name__ == '__main__':
    print("💰 Simple Market Price API Starting...")
    print(f"📊 Database: {DB_NAME}")
    print(f"🌾 Available crops: {len(MARKET_PRICES)}")
    print(f"🏪 Available mandis: {len(MANDIS)}")
